...
const Create = require('../actions/users/create')
const { Get_all, Details} = require('../actions/users/read')
const Edit = require('../actions/users/update')
const Destroy = require('../actions/users/delete')
